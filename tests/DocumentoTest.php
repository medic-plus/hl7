...
class DocumentoTest extends TestCase {
    ...
    public function testAntecedentesHeredofamiliares() {
        $documento = new Documento();
        $AntecedenteHeredo = new AntecedentesHeredofamiliares("Prueba 1", true, true, true);
    ...
    public function testDatosDestinarios() {
        $documento = new Documento();
        $dato1 = new DatosDestinarios("Prueba 1");
        $documento->addDatosDestinarios($dato1);
        $expected = file_get_contents('./tests/files/segments/datosDestinarios.xml');
        $this->assertXmlStringEqualsXmlString($expected, DocumentoTest::exportDOM($documento));
    }
    ...
    public function testImpresionDiagnostico() {
        $documento = new Documento();
        $impresion = new ImpresionDiagnostica("Prueba");
